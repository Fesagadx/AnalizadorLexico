...
public class GUIAnalizadorLexicoRuby extends javax.swing.JFrame {

    /**
     * Creates new form GUIAnalizadorLexicoRuby
     */
    ...
    private void initComponents() {
        ...
        setTitle("ANALIZADOR LEXICO_RUBY");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("RESULTADO DE ANALISIS");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jLabel3.setText("GRUPO 1");
        jLabel5.setText("RUBY");
...
jTextArea1.setText("");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(GUIAnalizadorLexicoRuby.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIAnalizadorLexicoRuby().setVisible(true);
            }
        });
    }
